...
Virtual tables are essentially [table-valued functions](https://www.sqlite.org/vtab.html#tabfunc2); you can pass parameters to virtual tables, making them much more powerful.
